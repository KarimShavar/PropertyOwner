    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<PropertyContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("PropertyDB")));
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, PropertyContext propertyContext)
        {
            ...
            DataGeneration.SeedDataForDevelopment(propertyContext);
